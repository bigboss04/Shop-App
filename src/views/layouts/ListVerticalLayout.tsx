...
const StyleListItemText = styled(ListItemText, {
  // shouldForwardProp: (prop) => prop !== 'active' có tác dụng chặn không cho prop active bị truyền xuống DOM HTML, nhưng vẫn cho phép sử dụng nó trong styled component để định kiểu.
  shouldForwardProp: (prop) => prop !== 'active'
})<TListItemText>(({ theme, active }) => ({
  '.MuiTypography-root.MuiTypography-body1.MuiListItemText-primary': {
    textOverflow: 'ellipsis',
    overflow: 'hidden',
    display: 'block',
